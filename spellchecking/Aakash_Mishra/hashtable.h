...
class hashtable{
private:
    unsigned int collision;       // to detect the number of collisions the search or insert does
    unsigned int tablesize;// tablesize is defined here
    string hasharray[69997]; // hashtable is defined
    unsigned int elements;  // to check whether the table is full
public:
    hashtable(){
        tablesize = 69997;
        collision  = 0;
