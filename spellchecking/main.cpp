...
int main() {
    ...
    commandfile.open("/Users/aakashanandmishra/Downloads/Program3Fall2014wordlist"); // takes wordlist and streams it in input
   string inarra[70000];
    hashtable H;
    H.insert("H");
    string input1;  // to get the input in the line for the input file
    ifstream commandfile1; // this is used to access the input file
    commandfile1.open("/Users/aakashanandmishra/Downloads/Program3Fall2014input"); // streams the input sentence to check.
